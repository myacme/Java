...
public class ReflexTest {
    public static void main(String[] args) throws Exception {
        ...
        ReflexBean reflexBean2 = new ReflexBean(reflexBean);
        ...
        Object invoke = getAnInt.invoke(reflexBean);
        System.out.print("通过反射调用方法：");
        System.out.println(invoke.toString());
        //使用对象调用方法
        Class<? extends ReflexBean> class2 = reflexBean2.getClass();
        ReflexBean getBean = (ReflexBean)class2.getDeclaredMethod("getBean").invoke(reflexBean2);
        System.out.println("两个bean是否相等：" + (getBean==reflexBean) );
        //绕过泛型检查
